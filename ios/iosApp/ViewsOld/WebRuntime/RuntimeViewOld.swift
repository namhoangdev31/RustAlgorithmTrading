...
struct RuntimeViewOld: View {
    ...
    var body: some View {
        ...
        .supportedOrientationsOld(orientationMask)
    }
...
private struct RuntimeWebViewWrapperOld: UIViewRepresentable {
    let manifest: WebRuntimeManifest
    let httpUrl: String
...
private extension View {
    func supportedOrientationsOld(_ mask: UIInterfaceOrientationMask) -> some View {
        self.onAppear {

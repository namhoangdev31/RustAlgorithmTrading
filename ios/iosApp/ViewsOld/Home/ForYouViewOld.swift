...
struct ForYouViewOld: View {
    @EnvironmentObject var navigation: NavigationViewModel
    
    // Mock Data
    private let recommendations = [
        (name: "Zen Focus", icon: "brain.head.profile", color: Color.purple, category: "Productivity", rating: 4.8),
        (name: "Daily Planner", icon: "calendar", color: Color.blue, category: "Productivity", rating: 4.7),
        (name: "Hydrate", icon: "drop.fill", color: Color.cyan, category: "Health", rating: 4.9),
        (name: "Sleep Well", icon: "moon.stars.fill", color: Color.indigo, category: "Health", rating: 4.6),
        (name: "FitTrack", icon: "figure.run", color: Color.green, category: "Fitness", rating: 4.5),
        ...
        (name: "Learn Code", icon: "laptopcomputer", color: Color.gray, category: "Education", rating: 4.9)
    ]

...
struct MiniAppDetailsViewOld: View {
    @EnvironmentObject var navigation: NavigationViewModel
    @StateObject private var viewModel = MiniAppDetailsViewStateOld(appId: "mock_app_1")
    ...
    var body: some View {
        ZStack(alignment: .bottom) {
            ...
            .onChange(of: offsetY) { _ , newValue in
                let shouldShow = newValue < -80 // Native coordinate system: scrolling down makes Y negative

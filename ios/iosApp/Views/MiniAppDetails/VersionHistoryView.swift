...
struct VersionHistoryView: View {
    ...
    let versions = [
        Version(version: "2.1.0", date: "2 days ago", notes: "• Added new dark mode support\n• Fixed crashing issue on startup\n• Performance improvements"),
        Version(version: "2.0.5", date: "1 week ago", notes: "• Bug fixes and stability improvements"),
        Version(version: "2.0.0", date: "1 month ago", notes: "• Major update! New UI redesign\n• Added cloud sync feature\n• Improved search functionality"),

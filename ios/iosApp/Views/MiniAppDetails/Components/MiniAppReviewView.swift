    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 15) {
            ...
            VStack(alignment: .leading, spacing: 8) {
                ...
                Text("The UI is beautiful and the tracking is scary accurate. I've already reduced my weekly carbon output by 15% just by making small changes recommended by the app.")
                    .font(.body)
                    .lineLimit(4)
                    .padding(.top, 4)
            }

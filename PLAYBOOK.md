...
| `ios/Libraries/AdaptiveSwiftUi/Sources/AdaptiveSwiftUi/Compatibility/AdaptiveViews.swift` | Generic view-level compatibility wrappers | `adaptiveControlSize(_:)`, `adaptiveContainerBackground(_:for:)`, `adaptiveBackgroundExtensionEffect()`, `adaptiveGlassEffect()`. |
...
| `ios/Libraries/AdaptiveSwiftUi/Sources/AdaptiveSwiftUi/Compatibility/AdaptiveNavigations.swift` | Navigation compatibility wrappers | `adaptiveNavigationTitle(_:subtitle:)`. |

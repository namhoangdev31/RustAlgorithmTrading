---
name: "source-command-flow-nexus-swarm"
description: "AI swarm deployment and coordination in cloud"
---

# source-command-flow-nexus-swarm

Use this skill when the user asks to run the migrated source command `flow-nexus-swarm`.

---
name: "source-command-flow-nexus-neural-network"
description: "Train and deploy neural networks in distributed sandboxes"
---

# source-command-flow-nexus-neural-network

Use this skill when the user asks to run the migrated source command `flow-nexus-neural-network`.

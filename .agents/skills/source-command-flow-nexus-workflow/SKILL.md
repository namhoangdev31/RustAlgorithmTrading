---
name: "source-command-flow-nexus-workflow"
description: "Event-driven workflow automation with message queues"
---

# source-command-flow-nexus-workflow

Use this skill when the user asks to run the migrated source command `flow-nexus-workflow`.

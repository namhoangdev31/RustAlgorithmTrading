---
name: "source-command-flow-nexus-sandbox"
description: "E2B sandbox management for isolated code execution"
---

# source-command-flow-nexus-sandbox

Use this skill when the user asks to run the migrated source command `flow-nexus-sandbox`.

---
name: "source-command-flow-nexus-challenges"
description: "Coding challenges, achievements, and leaderboards"
---

# source-command-flow-nexus-challenges

Use this skill when the user asks to run the migrated source command `flow-nexus-challenges`.

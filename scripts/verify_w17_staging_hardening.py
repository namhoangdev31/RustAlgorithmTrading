...
def run_staging_verification():
    ...
    checks = {
        "EV-W17-201": any(
            "EV-W17-201" in r.evidence_ids and r.disposition == "PASS" for r in manager.records
        ),
        "EV-W17-202": summary["kill_switch_latency_sec"] <= 60.0,
        "EV-W17-203": summary["rollback_success_rate"] >= 1.0,
        "EV-W17-204": any(
            "EV-W17-204" in r.evidence_ids and r.disposition == "PASS" for r in manager.records
        ),
        "EV-W17-205": any(
            "EV-W17-205" in r.evidence_ids and r.disposition == "PASS" for r in manager.records
        ),
        "EV-W17-206": summary["alert_fp_rate"] <= 0.15 and summary["critical_fn_count"] == 0,
        "EV-W17-207": any(
            "EV-W17-207" in r.evidence_ids and r.disposition == "PASS" for r in manager.records
        ),
        "EV-W17-208": any(
            "EV-W17-208" in r.evidence_ids and r.disposition == "PASS" for r in manager.records
        ),
        "EV-W17-209": any(
            "EV-W17-209" in r.evidence_ids
            and r.disposition == "PASS"
            and r.metadata.get("findings") == 0

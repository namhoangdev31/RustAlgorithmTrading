...
class TestPositionSizing:
    ...
    def test_position_size_basic(self):
        ...
        assert (
            abs(position_size - expected_shares) < 0.1
        ), f"Expected ~{expected_shares}, got {position_size}"
...
class TestRiskManagement:
    ...
    def test_position_size_limits(self):
        ...
        strategy = SimpleMomentumStrategy(symbols=["TEST"], position_size=0.1)  # 10% max
        ...
        ), f"Position {position_value} exceeds limit {max_allowed}"
...
class TestSimpleMomentumStrategy:
    ...
    def test_initialization(self):
        ...
        strategy = SimpleMomentumStrategy(
            symbols=symbols, rsi_period=14, rsi_oversold=35, rsi_overbought=65, position_size=0.1
        )
    ...
    def test_position_size_safety(self):
        ...
        strategy = SimpleMomentumStrategy(symbols=["TEST"], position_size=0.1)

...
class DriftDetector:
    ...
    def calculate_reproducibility_drift(self, run1_metrics: Dict[str, Any], run2_metrics: Dict[str, Any]) -> Dict[str, Any]:
        """
    ...
    def detect_performance_drift(self, baseline_metrics: Dict[str, Any], current_metrics: Dict[str, Any]) -> Dict[str, Any]:
        """

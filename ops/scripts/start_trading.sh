...
#
# Usage: ./ops/scripts/start_trading.sh [OPTIONS]
...
start_observability() {
    ...
    echo $OBSERVABILITY_PID > "$PROJECT_ROOT/ops/deployment/monitoring/observability_api.pid"
...
cleanup() {
    ...
    local pid_files=(
        "$PROJECT_ROOT/ops/deployment/monitoring/observability_api.pid"
        "$PROJECT_ROOT/ops/deployment/monitoring/dashboard.pid"

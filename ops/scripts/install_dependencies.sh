...
install_python_deps() {
    ...
    pip3 install -r "$PROJECT_ROOT/python/requirements.txt" >/dev/null 2>&1
...
main() {
    ...
    echo "  2. Run ./ops/scripts/check_dependencies.sh to verify"
    echo "  3. Configure your .env file"
    echo "  4. Run ./ops/scripts/start_trading.sh to start the system"
}

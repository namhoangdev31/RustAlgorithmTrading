...
jobs:
  staging-tests:
    ...
    steps:
      ...
      - name: Deploy Staging
        run: ./ops/scripts/deploy-staging.sh

      - name: Verify Deployment
        run: ./ops/scripts/verify-staging.sh

      - name: Run Load Tests
        run: ./ops/scripts/run-load-tests.sh
...
2. Run verification: `./ops/scripts/verify-staging.sh`

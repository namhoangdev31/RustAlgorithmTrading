...
func (_q *NotificationsQuery) QueryActor() *UserQuery {
	...
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		...
		step := sqlgraph.NewStep(
			sqlgraph.From(notifications.Table, notifications.FieldID, selector),
			sqlgraph.To(user.Table, user.FieldID),
			sqlgraph.Edge(sqlgraph.M2O, true, notifications.ActorTable, notifications.ActorColumn),
		)
...
func (_q *NotificationsQuery) QueryRecipient() *UserQuery {
	query := (&UserClient{config: _q.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := _q.prepareQuery(ctx); err != nil {
			return nil, err
		...
		step := sqlgraph.NewStep(
			sqlgraph.From(notifications.Table, notifications.FieldID, selector),
			sqlgraph.To(user.Table, user.FieldID),
			sqlgraph.Edge(sqlgraph.M2O, true, notifications.RecipientTable, notifications.RecipientColumn),
		)
		fromU = sqlgraph.SetNeighbors(_q.driver.Dialect(), step)
		return fromU, nil
	}
...
func (_q *NotificationsQuery) FirstID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (_q *NotificationsQuery) FirstIDX(ctx context.Context) uuid.UUID {
...
func (_q *NotificationsQuery) OnlyID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (_q *NotificationsQuery) OnlyIDX(ctx context.Context) uuid.UUID {
...
func (_q *NotificationsQuery) IDs(ctx context.Context) (ids []uuid.UUID, err error) {
...
func (_q *NotificationsQuery) IDsX(ctx context.Context) []uuid.UUID {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *NotificationsQuery) WithActor(opts ...func(*UserQuery)) *NotificationsQuery {
	query := (&UserClient{config: _q.config}).Query()
...
func (_q *NotificationsQuery) WithRecipient(opts ...func(*UserQuery)) *NotificationsQuery {
	query := (&UserClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *NotificationsQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Notifications, error) {
	...
	if query := _q.withActor; query != nil {
		if err := _q.loadActor(ctx, query, nodes, nil,
			func(n *Notifications, e *User) { n.Edges.Actor = e }); err != nil {
			return nil, err
		}
	}
	if query := _q.withRecipient; query != nil {
		if err := _q.loadRecipient(ctx, query, nodes, nil,
			func(n *Notifications, e *User) { n.Edges.Recipient = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *NotificationsQuery) loadActor(ctx context.Context, query *UserQuery, nodes []*Notifications, init func(*Notifications), assign func(*Notifications, *User)) error {
	ids := make([]uuid.UUID, 0, len(nodes))
	nodeids := make(map[uuid.UUID][]*Notifications)
	for i := range nodes {
...
func (_q *NotificationsQuery) loadRecipient(ctx context.Context, query *UserQuery, nodes []*Notifications, init func(*Notifications), assign func(*Notifications, *User)) error {
	ids := make([]uuid.UUID, 0, len(nodes))
	nodeids := make(map[uuid.UUID][]*Notifications)
	for i := range nodes {
	...
	for _, n := range neighbors {
		nodes, ok := nodeids[n.ID]
		if !ok {
			return fmt.Errorf(`unexpected foreign-key "recipientId" returned %v`, n.ID)
		}
		for i := range nodes {
			assign(nodes[i], n)
		}
...
func (_q *NotificationsQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(notifications.Table, notifications.Columns, sqlgraph.NewFieldSpec(notifications.FieldID, field.TypeUUID))
	_spec.From = _q.sql
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withActor != nil {
			_spec.Node.AddColumnOnce(notifications.FieldActorId)
		}
		if _q.withRecipient != nil {
			_spec.Node.AddColumnOnce(notifications.FieldRecipientId)
		}
	}
...
func (_q *NotificationsQuery) ForUpdate(opts ...sql.LockOption) *NotificationsQuery {
...
func (_q *NotificationsQuery) ForShare(opts ...sql.LockOption) *NotificationsQuery {
	if _q.driver.Dialect() == dialect.Postgres {
		_q.Unique(false)
	}
	_q.modifiers = append(_q.modifiers, func(s *sql.Selector) {
...
func (_q *NotificationsQuery) Modify(modifiers ...func(s *sql.Selector)) *NotificationsSelect {
...
// Modify adds a query modifier for attaching custom logic to queries.
func (_s *NotificationsSelect) Modify(modifiers ...func(s *sql.Selector)) *NotificationsSelect {

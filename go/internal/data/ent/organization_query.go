...
type OrganizationQuery struct {
	...
	withSsoConfig           *SsoConfigQuery
	withNativeScimMappings  *NativeScimMappingQuery
	withMembers             *OrganizationMembershipQuery
	withProviderConnections *WorkspaceProviderConnectionQuery
...
// QuerySsoConfig chains the current query on the "ssoConfig" edge.
func (_q *OrganizationQuery) QuerySsoConfig() *SsoConfigQuery {
	query := (&SsoConfigClient{config: _q.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := _q.prepareQuery(ctx); err != nil {
			return nil, err
		}
		...
		step := sqlgraph.NewStep(
			sqlgraph.From(organization.Table, organization.FieldID, selector),
			sqlgraph.To(ssoconfig.Table, ssoconfig.FieldID),
			sqlgraph.Edge(sqlgraph.O2O, false, organization.SsoConfigTable, organization.SsoConfigColumn),
		)
		fromU = sqlgraph.SetNeighbors(_q.driver.Dialect(), step)
		return fromU, nil
	}
...
// QueryNativeScimMappings chains the current query on the "nativeScimMappings" edge.
func (_q *OrganizationQuery) QueryNativeScimMappings() *NativeScimMappingQuery {
	query := (&NativeScimMappingClient{config: _q.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := _q.prepareQuery(ctx); err != nil {
			return nil, err
		}
		...
		step := sqlgraph.NewStep(
			sqlgraph.From(organization.Table, organization.FieldID, selector),
			sqlgraph.To(nativescimmapping.Table, nativescimmapping.FieldID),
			sqlgraph.Edge(sqlgraph.O2M, false, organization.NativeScimMappingsTable, organization.NativeScimMappingsColumn),
		)
		fromU = sqlgraph.SetNeighbors(_q.driver.Dialect(), step)
		return fromU, nil
	}
...
func (_q *OrganizationQuery) QueryMembers() *OrganizationMembershipQuery {
...
// QueryProviderConnections chains the current query on the "providerConnections" edge.
func (_q *OrganizationQuery) QueryProviderConnections() *WorkspaceProviderConnectionQuery {
	...
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		...
		step := sqlgraph.NewStep(
			...
			sqlgraph.Edge(sqlgraph.O2M, false, organization.ProviderConnectionsTable, organization.ProviderConnectionsColumn),
		)
		fromU = sqlgraph.SetNeighbors(_q.driver.Dialect(), step)
		return fromU, nil
	}
...
func (_q *OrganizationQuery) Clone() *OrganizationQuery {
	...
	return &OrganizationQuery{
		...
		withSsoConfig:           _q.withSsoConfig.Clone(),
		withNativeScimMappings:  _q.withNativeScimMappings.Clone(),
		withMembers:             _q.withMembers.Clone(),
		withProviderConnections: _q.withProviderConnections.Clone(),
...
// WithSsoConfig tells the query-builder to eager-load the nodes that are connected to
// the "ssoConfig" edge. The optional arguments are used to configure the query builder of the edge.
func (_q *OrganizationQuery) WithSsoConfig(opts ...func(*SsoConfigQuery)) *OrganizationQuery {
	query := (&SsoConfigClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	_q.withSsoConfig = query
	return _q
}

// WithNativeScimMappings tells the query-builder to eager-load the nodes that are connected to
// the "nativeScimMappings" edge. The optional arguments are used to configure the query builder of the edge.
func (_q *OrganizationQuery) WithNativeScimMappings(opts ...func(*NativeScimMappingQuery)) *OrganizationQuery {
	query := (&NativeScimMappingClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	_q.withNativeScimMappings = query
	return _q
}

// WithMembers tells the query-builder to eager-load the nodes that are connected to
// the "members" edge. The optional arguments are used to configure the query builder of the edge.
func (_q *OrganizationQuery) WithMembers(opts ...func(*OrganizationMembershipQuery)) *OrganizationQuery {
	query := (&OrganizationMembershipClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
// WithProviderConnections tells the query-builder to eager-load the nodes that are connected to
// the "providerConnections" edge. The optional arguments are used to configure the query builder of the edge.
func (_q *OrganizationQuery) WithProviderConnections(opts ...func(*WorkspaceProviderConnectionQuery)) *OrganizationQuery {
	query := (&WorkspaceProviderConnectionClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	_q.withProviderConnections = query
	return _q
}
...
func (_q *OrganizationQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Organization, error) {
	var (
		...
		loadedTypes = [6]bool{
			_q.withUser != nil,
			_q.withProjects != nil,
			_q.withSsoConfig != nil,
			_q.withNativeScimMappings != nil,
			_q.withMembers != nil,
			_q.withProviderConnections != nil,
		}
	)
	...
	if query := _q.withSsoConfig; query != nil {
		if err := _q.loadSsoConfig(ctx, query, nodes, nil,
			func(n *Organization, e *SsoConfig) { n.Edges.SsoConfig = e }); err != nil {
			return nil, err
		}
	}
	if query := _q.withNativeScimMappings; query != nil {
		if err := _q.loadNativeScimMappings(ctx, query, nodes,
			func(n *Organization) { n.Edges.NativeScimMappings = []*NativeScimMapping{} },
			func(n *Organization, e *NativeScimMapping) {
				n.Edges.NativeScimMappings = append(n.Edges.NativeScimMappings, e)
			}); err != nil {
			return nil, err
		}
	}
	if query := _q.withMembers; query != nil {
		if err := _q.loadMembers(ctx, query, nodes,
			func(n *Organization) { n.Edges.Members = []*OrganizationMembership{} },
			func(n *Organization, e *OrganizationMembership) { n.Edges.Members = append(n.Edges.Members, e) }); err != nil {
			return nil, err
		}
	}
	if query := _q.withProviderConnections; query != nil {
		if err := _q.loadProviderConnections(ctx, query, nodes,
			func(n *Organization) { n.Edges.ProviderConnections = []*WorkspaceProviderConnection{} },
			func(n *Organization, e *WorkspaceProviderConnection) {
				n.Edges.ProviderConnections = append(n.Edges.ProviderConnections, e)
			}); err != nil {
			return nil, err
		}
	}
...
func (_q *OrganizationQuery) loadProjects(ctx context.Context, query *ProjectQuery, nodes []*Organization, init func(*Organization), assign func(*Organization, *Project)) error {
	...
	for _, n := range neighbors {
		...
		node, ok := nodeids[fk]
		if !ok {
			return fmt.Errorf(`unexpected referenced foreign-key "organizationId" returned %v for node %v`, fk, n.ID)
		}
		assign(node, n)
	}
	return nil
}
func (_q *OrganizationQuery) loadSsoConfig(ctx context.Context, query *SsoConfigQuery, nodes []*Organization, init func(*Organization), assign func(*Organization, *SsoConfig)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[uuid.UUID]*Organization)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(ssoconfig.FieldOrganizationId)
	}
	query.Where(predicate.SsoConfig(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(organization.SsoConfigColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (_q *OrganizationQuery) loadNativeScimMappings(ctx context.Context, query *NativeScimMappingQuery, nodes []*Organization, init func(*Organization), assign func(*Organization, *NativeScimMapping)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[uuid.UUID]*Organization)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(nativescimmapping.FieldOrganizationId)
	}
	query.Where(predicate.NativeScimMapping(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(organization.NativeScimMappingsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (_q *OrganizationQuery) loadMembers(ctx context.Context, query *OrganizationMembershipQuery, nodes []*Organization, init func(*Organization), assign func(*Organization, *OrganizationMembership)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[uuid.UUID]*Organization)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
...
func (_q *OrganizationQuery) loadProviderConnections(ctx context.Context, query *WorkspaceProviderConnectionQuery, nodes []*Organization, init func(*Organization), assign func(*Organization, *WorkspaceProviderConnection)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[uuid.UUID]*Organization)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(workspaceproviderconnection.FieldOrganizationId)
	}
	query.Where(predicate.WorkspaceProviderConnection(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(organization.ProviderConnectionsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (_q *OrganizationQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withUser != nil {
			_spec.Node.AddColumnOnce(organization.FieldUserId)
		}
	}

...
func NewEntRiskLimitsRepository(store *storage.Store) repositories.RiskLimitsRepository {
	if store == nil || store.Postgres() == nil {
		return &EntRiskLimitsRepository{}
	}
	return &EntRiskLimitsRepository{client: store.Postgres().Ent()}
}

func (r *EntRiskLimitsRepository) GetRiskLimits(ctx context.Context, accountID *string) (*entities.RiskLimits, error) {
	if r.client == nil {
...
func (r *EntRiskLimitsRepository) SaveRiskLimits(ctx context.Context, limits *entities.RiskLimits) error {
	if r.client == nil {
...
func setRiskMutation(m *entdb.RiskLimitsMutation, value *entities.RiskLimits) error {
...
func riskEntity(row *entdb.RiskLimits) *entities.RiskLimits {
	return &entities.RiskLimits{

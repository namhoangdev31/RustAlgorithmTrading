...
func (r *Repository) renewDomainCertificate(ctx context.Context, adapterURL, token string, domain lepoSSLDomainConfig) (lepoSSLRenewalResponse, bool) {
...
func (r *Repository) offlineToken(entitlementID, deviceID string) string {
...
func (r *Repository) artifactURL(storageKey string) string {
	base := r.config.ArtifactPublicURL
	if base == "" {
		return ""
	}

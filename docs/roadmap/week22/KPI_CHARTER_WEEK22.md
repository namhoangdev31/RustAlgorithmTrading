...
| W09-W21 regression guard | `100%` | required slices pass | `100%` | `CAPTURED_PASS` | `EV-W22-301..306` | `tester` |
| Artifact consistency | `100%` | baseline/issue/KPI/gate/final same verdict | `100%` (`GO` thống nhất) | `CAPTURED_PASS` | `EV-W22-401`,`EV-W22-402` | `planner` |

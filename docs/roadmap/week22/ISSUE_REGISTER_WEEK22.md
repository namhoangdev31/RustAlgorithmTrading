...
|---|---|---|---|---|---|---|---|---|
| `W22-ISS-001` | P0 | `BLOCKED` | `tester` | `Pha 3` | Full Python unit+integration gate | `EV-W22-201` | close python unit/integration failures + rerun | Python suites pass `100%` |
...
| `W22-ISS-003` | P0 | `BLOCKED` | `coder` | `Pha 3` | Cross-runtime integration gate | `EV-W22-203` | close failing cross-runtime integration suites + rerun | required slices pass |
| `W22-ISS-004` | P1 | `IN_PROGRESS` | `tester` | `Pha 4` | Integration debt closure | `EV-W22-204` | close debt backlog after `W22-ISS-001/003` unblock | debt open `=0` |
...
| `W22-ISS-007` | P1 | `BLOCKED` | `tester` | `Pha 5` | Regression guard | `EV-W22-301..306` | close failing guard (`verify_w15_capital_allocation.py`) then rerun | regression guard pass |

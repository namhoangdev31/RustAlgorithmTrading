...
|---|---|---|---|---|---|---|---|---|
| `W21-ISS-001` | P0 | `BLOCKED` | `coder` | `Pha 3` | Full lint gate | `EV-W21-201` | install missing lint tools + close rust fmt/clippy blockers + rerun full lint profile | lint pass `100%` |
| `W21-ISS-002` | P0 | `BLOCKED` | `coder` | `Pha 3` | Full type/static gate | `EV-W21-202` | fix mypy module-path/stubs + install pyright + rerun type/static profile | type/static pass `100%` |
| `W21-ISS-003` | P0 | `BLOCKED` | `tester` | `Pha 3` | Full unit baseline gate | `EV-W21-203` | fix Python import/packaging collection errors + rerun full unit baseline | unit baseline pass `100%` |
| `W21-ISS-004` | P1 | `IN_PROGRESS` | `tester` | `Pha 4` | Test debt closure | `EV-W21-204` | close debt backlog after unit baseline unblocked | debt open `=0` |

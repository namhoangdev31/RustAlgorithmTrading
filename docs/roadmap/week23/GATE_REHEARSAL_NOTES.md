...
|---|---|---|---|---|
| Full cross-runtime/e2e pass | `100%` | `EV-W23-201` | `PASS` | full profile |
| Soak scenario pass | `100%` | `EV-W23-202` | `PASS` | soak scenarios |
| Fault-injection pass | `100%` | `EV-W23-203` | `PASS` | fault scenarios |
| E2E/fault debt closure | open debt `=0` | `EV-W23-204` | `PASS` | debt queue |
| Correlation coverage | `>=99%` | `EV-W23-205` | `PASS` | audit coverage |
| Compliance findings | `0` | `EV-W23-206` | `PASS` | compliance output |
| W09-W22 regression guard | `100%` pass | `EV-W23-301..306` | `PASS` | guardrails |
| Artifact consistency | one final verdict | `EV-W23-401`,`EV-W23-402` | `PASS` | reconciliation |

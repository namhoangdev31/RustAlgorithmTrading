...
|---|---|---|---|---|---|
| `EV-W23-101` | `python -m pytest tests/e2e -q` | pass | `PENDING_CAPTURE` | `PENDING_EXECUTION` | `W23-ISS-001`,`W23-ISS-004` |
| `EV-W23-102` | `python -m pytest tests/integration -q` | pass | `PENDING_CAPTURE` | `PENDING_EXECUTION` | `W23-ISS-001` |
| `EV-W23-103` | `python -m pytest tests/observability -q` | pass | `PENDING_CAPTURE` | `PENDING_EXECUTION` | `W23-ISS-006` |
| `EV-W23-104` | `cd rust && PYO3_USE_ABI3_FORWARD_COMPATIBILITY=1 cargo test --workspace` | pass | `PENDING_CAPTURE` | `PENDING_EXECUTION` | `W23-ISS-001`,`W23-ISS-003` |
| `EV-W23-105` | `cd rust && PYO3_USE_ABI3_FORWARD_COMPATIBILITY=1 cargo check --workspace` | pass | `PENDING_CAPTURE` | `PENDING_EXECUTION` | `W23-ISS-010` |
| `EV-W23-106` | Soak harness run | pass required scenarios | `PENDING_CAPTURE` | `PENDING_EXECUTION` | `W23-ISS-002`,`W23-ISS-011` |
| `EV-W23-107` | Fault-injection harness run | pass required scenarios | `PENDING_CAPTURE` | `PENDING_EXECUTION` | `W23-ISS-003` |
| `EV-W23-108` | `bash scripts/compliance_audit.sh --check-correlation --check-versioning` | pass | `PENDING_CAPTURE` | `PENDING_EXECUTION` | `W23-ISS-006` |
| `EV-W23-109` | `python scripts/audit_correlation.py --fail-on-findings` | `0 findings` | `PENDING_CAPTURE` | `PENDING_EXECUTION` | `W23-ISS-012` |
| `EV-W23-110` | `bash scripts/health_check.sh` | pass | `PENDING_CAPTURE` | `PENDING_EXECUTION` | `W23-ISS-002` |

## 4) Hard-gate3 rehearsal matrix

| Evidence ID | Scenario | Expected | Actual | Status | Blocking issue |
|---|---|---|---|---|---|
| `EV-W23-201` | Full cross-runtime/e2e pass audit | `100%` | `PENDING_CAPTURE` | `PENDING_EXECUTION` | `W23-ISS-001` |
| `EV-W23-202` | Soak scenario pass audit | `100%` | `PENDING_CAPTURE` | `PENDING_EXECUTION` | `W23-ISS-002` |
| `EV-W23-203` | Fault-injection pass audit | `100%` | `PENDING_CAPTURE` | `PENDING_EXECUTION` | `W23-ISS-003` |
| `EV-W23-204` | E2E/fault debt closure audit | open debt `=0` | `PENDING_CAPTURE` | `PENDING_EXECUTION` | `W23-ISS-004` |
| `EV-W23-205` | Correlation coverage audit | `>=99%` | `PENDING_CAPTURE` | `PENDING_EXECUTION` | `W23-ISS-006` |
| `EV-W23-206` | Compliance findings audit | findings `=0` | `PENDING_CAPTURE` | `PENDING_EXECUTION` | `W23-ISS-012` |

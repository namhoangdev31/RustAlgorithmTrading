...
| `W24-ISS-002` | P0 | `BLOCKED` | `planner` | after W23 recovery | Controlled live ready gate | `EV-W24-001`,`EV-W24-110`,`EV-W24-202` | remove W23 env waiver/pending artifacts, rerun W24 verifier | release gate pass `100%` |
...
| `W24-ISS-004` | P1 | `BLOCKED` | `planner` | after `W24-ISS-002`,`W24-ISS-006` | Release blocker closure | `EV-W24-204` | close W23 precondition and W21 guard blockers | blockers open `=0` |
...
| `W24-ISS-006` | P1 | `BLOCKED` | `tester` | after W21 recovery | Regression guard | `EV-W24-304`,`EV-W24-301..306` | close W21 lint/type/static/debt blockers, rerun guard | regression guard pass |
| `W24-ISS-007` | P1 | `DONE` | `planner` | `Pha 6` | Final verdict consistency | `EV-W24-401`,`EV-W24-402` | reconcile W24 artifacts to `NO-GO` | one final verdict |
| `W24-ISS-008` | P1 | `BLOCKED` | `planner` | after all mandatory pass | Final approval | `EV-W24-205` | approve only after W23/W21 blockers close | approval complete |
...
- W24 cannot lock `GO` while `W24-ISS-002`, `W24-ISS-004`, `W24-ISS-006`, or `W24-ISS-008` are not `DONE`.
- Current final verdict: `NO-GO`.

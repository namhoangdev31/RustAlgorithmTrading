...
|---|---|---|---|---|---|
| Compile/static/lint/type profile | `100% pass` | `all profiles pass` | `CAPTURED_PASS` | `EV-W10-101..107` | `tester` |
| Critical path smoke pass rate | `>=95%` | `2/2 slices pass` | `CAPTURED_PASS` | `EV-W10-103`,`EV-W10-104` | `tester` |
| `/health` p95 latency | `<=100ms` local/test profile | `p95=0.29ms` | `CAPTURED_PASS` | `EV-W10-201` | `ops` |
...
| `/api/system/health` p95 latency | `<=250ms` local/test profile | `p95=0.25ms` | `CAPTURED_PASS` | `EV-W10-204` | `ops` |
...
| WebSocket heartbeat success | `>=99%` sample | `100% success rate` | `CAPTURED_PASS` | `EV-W10-206` | `tester` |
| Event-to-alert latency | `<=120s` temporary W10 target | `max_latency=64.0s` | `CAPTURED_PASS` | `EV-W10-207` | `ops` |
| Alert false-positive sample | `<=15%` | `10.00%` | `CAPTURED_PASS` | `EV-W10-208` | `ops` |
| Alert false-negative critical | `0` | `0 findings` | `CAPTURED_PASS` | `EV-W10-209` | `ops` |
| Alert acknowledgement success | `100%` sample | `acknowledged` | `CAPTURED_PASS` | `EV-W10-210` | `ops` |
| Dashboard SLO panel availability | `>=95%` | `100.00% availability` | `CAPTURED_PASS` | `EV-W10-211` | `ops` |
| Correlation coverage | `>=99%` critical events | `100.00% coverage` | `CAPTURED_PASS` | `EV-W10-108`,`EV-W10-212` | `ops` |
...
| Artifact consistency | one final decision | `all gate artifacts = GO` | `CAPTURED_PASS` | `EV-W10-402` | `planner` |
...
- Current KPI color: `GREEN`.
- Current gate verdict: `GO`.

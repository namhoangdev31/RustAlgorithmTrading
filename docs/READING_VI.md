# README Tiếng Việt - RustAlgorithmTrading (py_rt)
...
`py_rt` là hệ thống giao dịch thuật toán hybrid:
...
- **Cầu nối Python-Rust**: ONNX, ZeroMQ, và cấu hình chia sẻ.
...
- DuckDB observability storage: `docs/observability/OBSERVABILITY_DUCKDB.md`
...
- `docs/architecture/production-architecture.md` (ưu tiên)
- `docs/architecture/python-rust-separation.md`
- `docs/architecture/python-rust-integration.md`
...
- `docs/observability/OBSERVABILITY_DUCKDB.md`
...
2. Nhiều tài liệu `docs/legacy/*` có giá trị lịch sử, không dùng làm operational truth.

    ...
    <Card className="border border-hairline bg-canvas py-0">
      <CardHeader className="border-b border-hairline-cool bg-canvas-soft/60 p-5">
        <div className="flex items-center gap-2">
          ...
          <span className="bg-secondary text-muted-foreground border border-border text-[9px] font-bold px-1.5 py-0.5 rounded uppercase tracking-wider select-none">
            Evidence-backed
          </span>
        </div>
        <CardDescription className="text-xs text-ink-mute">
          {locale === "vi"
            ? "Đăng ký danh tính dịch vụ, thiết lập cặp tin cậy và thu nạp các gói đo lường mã hóa tổng hợp được lưu lại."
            : "Register service identities, define trust pairs, and ingest persisted aggregate telemetry envelopes."}
        </CardDescription>
      </CardHeader>

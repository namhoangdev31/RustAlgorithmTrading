...
export function LeposCommandPalette() {
  ...
  const commands = [
    ...
    { icon: Terminal, name: "LepoShip Mobile Builder", description: "Open WebView bundle manager", action: () => router.push("/lepoship") },
        ...
        <div className="max-h-[320px] overflow-y-auto p-2 space-y-1">
          {filteredCommands.length > 0 ? (
            ...
            <div className="flex flex-col items-center justify-center py-8 text-zinc-500">
              ...
              <p className="text-xs">No commands found matching "{search}"</p>
            </div>
          )}
        </div>

  ...
  return (
    <div className="grid grid-cols-1 xl:grid-cols-3 gap-4">
      <Card className="xl:col-span-2 bg-canvas border border-hairline rounded-lg p-5">
        <div className="mb-5">
          <h3 className="text-ink text-base font-semibold">Project Settings</h3>
          <p className="text-ink-mute text-xs mt-1">Default behavior applied to newly created projects and bundles.</p>
        </div>
      ...
      <Card className="bg-canvas border border-hairline rounded-lg p-5">
        <h3 className="text-ink text-base font-semibold">Danger Zone</h3>
        <p className="text-ink-mute text-xs mt-1">Critical actions for workspace projects.</p>

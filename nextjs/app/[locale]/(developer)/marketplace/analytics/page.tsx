  ...
  if (!collaborator || !collaborator.bundle) {
    return (
      <div className="flex flex-col gap-6">
        ...
        <Card className="border-dashed bg-card border-hairline">
          <CardHeader>
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        <Card className="bg-gradient-to-br from-emerald-500/10 to-teal-500/5 border-emerald-500/20">
          <CardHeader className="flex flex-row items-center justify-between pb-2 space-y-0">
            <CardTitle className="text-sm font-semibold">Active Installs</CardTitle>
        ...
        <Card className="bg-card border border-hairline">
          <CardHeader className="flex flex-row items-center justify-between pb-2 space-y-0">
            <CardTitle className="text-sm font-semibold">Total Installs</CardTitle>
        ...
        <Card className="bg-card border border-hairline">
          <CardHeader className="flex flex-row items-center justify-between pb-2 space-y-0">
            <CardTitle className="text-sm font-semibold">Uninstall Rate (Churn)</CardTitle>
        ...
        <Card className="bg-gradient-to-br from-amber-500/10 to-orange-500/5 border-amber-500/20">
          <CardHeader className="flex flex-row items-center justify-between pb-2 space-y-0">
            <CardTitle className="text-sm font-semibold">Exceptions & Errors</CardTitle>
          ...
          <CardContent className="flex flex-col gap-4">
            {topPlugins.length === 0 ? (
              ...
              topPlugins.map((plugin, index) => (
                <div key={plugin.bundleId} className="flex items-center justify-between border-b border-hairline pb-2 last:border-0 last:pb-0">
          ...
          {analytics.errorBreakdown.length === 0 ? (
            ...
            <div className="relative w-full overflow-auto">
              <table className="w-full caption-bottom text-sm">
                <thead>
                  <tr className="border-b border-hairline transition-colors hover:bg-muted/50">
                ...
                <tbody>
                  {analytics.errorBreakdown.map((err, idx) => (
                    <tr key={idx} className="border-b border-hairline transition-colors hover:bg-muted/50">

...
import { ProjectSecuritySurface } from "@/components/portal/ProjectSecuritySurface";

type PageProps = {
  params: Promise<{ locale: string; projectId: string }>;
};

export default async function ProjectSecurityPage({ params }: PageProps) {
  ...
  return <ProjectSecuritySurface project={project} data={nativePlatformData} locale={locale} />;
}

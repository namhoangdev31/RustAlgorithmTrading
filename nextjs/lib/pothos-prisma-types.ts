...
export default interface PrismaTypes {
    ...
    Organization: {
        ...
        Create: {};
        Update: {};
        RelationName: "user" | "projects" | "ssoConfig" | "nativeScimMappings";
        ListRelations: "projects" | "nativeScimMappings";
        Relations: {
            user: {
                Shape: User;
                Name: "User";

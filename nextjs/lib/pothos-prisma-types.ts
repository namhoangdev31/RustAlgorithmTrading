...
export default interface PrismaTypes {
    ...
    NativeDeployment: {
        ...
        Create: {};
        Update: {};
        RelationName: "project" | "activeProjects" | "sourceMaps";
        ListRelations: "activeProjects" | "sourceMaps";
        Relations: {
            project: {
                Shape: Project;
                Name: "Project";
    ...
    NativeAiDiagnostic: {
        ...
        Create: {};
        Update: {};
        RelationName: "project" | "crashReport";
        ListRelations: never;
        Relations: {
            project: {
                Shape: Project;

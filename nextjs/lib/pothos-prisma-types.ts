...
export default interface PrismaTypes {
    ...
    Project: {
        ...
        Create: {};
        Update: {};
        RelationName: "organization" | "bundle";
        ListRelations: never;
        Relations: {
            organization: {
                Shape: Organization;

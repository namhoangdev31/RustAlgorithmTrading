...
class TestSignalDataclass:
    ...
    def test_signal_with_all_signal_types(self):
        ...
        types_to_test = [SignalType.LONG, SignalType.SHORT, SignalType.EXIT, SignalType.HOLD]
...
class TestMomentumStrategySignalGeneration:
    ...
    def test_momentum_strategy_generates_valid_signal_types(self):
        ...
        strategy = MomentumStrategy(rsi_period=14, rsi_oversold=40, rsi_overbought=60)
